...
public class DisplayLeakService extends AbstractAnalysisResultService {
        ...
        if (!shouldSaveResult) {
            ...
            if (result.failure == null) {
                ...
                if (result.excludedLeak) {
                    ...
                    contentTitle =
                            getString(R.string.leak_canary_class_has_leaked, className, size);
                }
            } else {
    ...
    private HeapDump renameHeapdump(HeapDump heapDump) {
        String fileName =
                new SimpleDateFormat("yyyy-MM-dd_HH-mm-ss_SSS'.hprof'", Locale.US)
                        .format(new Date());
        ...
        heapDump =
                new HeapDump(newFile, heapDump.referenceKey, heapDump.referenceName,
                        heapDump.excludedRefs,
                        heapDump.watchDurationMs, heapDump.gcDurationMs,
